...
Prior to running this script you will need your login details for access.redhat.com to get a private registries and you will also need to <<Slackbot Setup,setup a slackbot with a webhook url>>
